...
<div style="display: flex; align-items: flex-start; margin: 30px 0; gap: 20px;">
  <div> <img src="/images/3-BlogsTranslated/image.png" alt="AWS Guide to Generative AI for Game Developers" style="width: 150px; height: auto;"></div>
...
<div style="display: flex; align-items: flex-start; margin: 30px 0; gap: 20px;">
  <div> <img src="/images/3-BlogsTranslated/image1.png" alt="Deliver Superior Gaming Experiences" style="width: 150px; height: auto;"></div>
...
<div style="display: flex; align-items: flex-start; margin: 30px 0; gap: 20px;">
  <div><img src="/images/3-BlogsTranslated/image2.png" alt="A guide to Amazon GameLift and game servers" style="width: 150px; height: auto;"></div>
...
<div style="display: flex; align-items: flex-start; margin: 30px 0; gap: 20px;">
  <div><img src="/images/3-BlogsTranslated/image3.png" alt="Reinventing game development" style="width: 150px; height: auto;"></div>
...
<div style="display: flex; align-items: flex-start; margin: 30px 0; gap: 20px;">
  <div><img src="/images/3-BlogsTranslated/image5.png" alt="Game on for LiveOps" style="width: 150px; height: auto;"></div>
